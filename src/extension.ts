...
export function activate(context: vscode.ExtensionContext) {
  ...
  var disposable = vscode.commands.registerCommand("extension.sayHello", () => {
    //this is like function () {} //anonymous don't change function
  ...
  var login = vscode.commands.registerCommand("extension.loginToTrello", () =>
    loginTrello()
  );
  var getBoards = vscode.commands.registerCommand(
    ...
    trelloClient
      ...
      .then(() => {
        return vsInterface.ShowBoards(
          trelloClient._boards,
          trelloClient._boardsIDs
        );
      })
      .then(selectedBoard => {
